package com.sagaorchestrated.orchestratorservice.config.kafka;
...
import static com.sagaorchestrated.orchestratorservice.core.enums.ETopics.*;
...
public class KafkaConfig {
  ...
  @Bean
  public NewTopic finishSuccessTopic() {return buildTopic(FINISH_SUCCESS.getTopic()); }

  @Bean
  public NewTopic finishFailTopic() {return buildTopic(FINISH_FAIL.getTopic()); }
